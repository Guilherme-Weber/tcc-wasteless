...
public class TelaStoreAnalisa extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tela_store_analisa);
    ...
    public void telaHomeCoordenador() {
        Intent tela = new Intent(TelaStoreAnalisa.this, TelaHomeStore.class)

...
public class TelaUserAnalisa extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tela_user_analisa);
    ...
    public void telaHomeScreen() {
        Intent tela = new Intent(TelaUserAnalisa.this, TelaUserVisualizar.class)
                .putExtra("nome", nome)
